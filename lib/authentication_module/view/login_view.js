...
import {
  ...
  SvgComponent,
  ShowPassSVG,
} from '../../../assets/svg_image/app_support_svg';
import {
  View,
  Text,
  TouchableOpacity,
...
import {
  ...
  OutlinedButton,
} from '../../utility/constants/custom_button';
...
const Login = ({navigation}) => {
  ...
  const _clientLogin = async () => {
    ...
    if (loginStatus === 1) {
      ...
      //Its throwing error , Do is Not handled By any Navigator
    } else {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animatable.View animation="fadeInUpBig" style={styles.footer}>
        ...
        <View
          style={[styles.action, {flexDirection: 'row', alignItems: 'center'}]}>
        ...
        <View style={styles.action}>
          <TextInput
            ...
            autoCapitalize="none"
            onChangeText={val =>
              handleInputChange('password', val, data.formKey)
            }
          />
