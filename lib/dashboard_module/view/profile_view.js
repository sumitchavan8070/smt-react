...
import AssetPath from '../../utility/constants/asset_path';
        ...
        return (
          <View>
            ...
            <TextInput
              ...
              onChangeText={text => handleChangeBasicInfo('mobileNumber', text)}
                ...
                <View>
                  {contactActive ? (
                    ...
                    <>
                      ...
                      <View>
                        <Text style={{fontWeight: 'bold'}}>What We Offer</Text>
                        <View style={{gap: 5, marginTop: 10, marginBottom: 10}}>
                          <Text>
                        ...
                        <Text style={{fontWeight: 'bold'}}>Why Choose Us</Text>
